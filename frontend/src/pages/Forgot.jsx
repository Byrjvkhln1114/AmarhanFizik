...
export const Forgot = () => {
  return (
    <div>
      <div
        className="d-flex flex-column  align-items-center forgot1"
      >
        <Header></Header>
        <div
          className="d-flex justify-content-center align-items-center flex-column forgot2"
        >
          <div className="w-75">
          ...
          <div
            className=" d-flex flex-column justify-content-around forgot5"
          >
            <div>
              <h5 style={{ fontWeight: "400" }}>И-мэйл</h5>
              <input className="forgot6"
                type="email"
